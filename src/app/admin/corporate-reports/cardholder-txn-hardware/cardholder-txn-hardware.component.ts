...
@Component({
  selector: "app-cardholder-txn-hardware",
  templateUrl: "./cardholder-txn-hardware.component.html",
  styleUrls: ["../../../scss/common-sales-style.scss"],
  encapsulation: ViewEncapsulation.Emulated,
})
export class CardholderTxnHardwareComponent implements OnInit, OnDestroy {
  ...
  setColData(lang: string) {
    this.colData = [
      ...
      { field: "assetId", header: "report.hardwareNumber" },
    ...
    if (data) {
      this.gridData = data.map((sale) => {
        return {
          ...
          assetSuspended: sale.assetSuspended,
