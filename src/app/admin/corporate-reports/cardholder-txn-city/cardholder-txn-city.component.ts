...
@Component({
  selector: "app-cardholder-txn-city",
  templateUrl: "./cardholder-txn-city.component.html",
  styleUrls: ["../../../scss/common-sales-style.scss"],
  encapsulation: ViewEncapsulation.Emulated,
})
export class CardholderTxnCityComponent implements OnInit, OnDestroy {
  ...
  setColData(lang: string) {
    this.colData = [
      ...
      {
        field: `${lang === "en" ? "zoneEnName" : "zoneLocaleName"}`,
        header: `${
          lang === "en" ? "report.zoneEnName" : "report.zoneLocaleName"
        }`,
      },
      {
        ...
        return {
          [`${
            ...
            this.currentLang === "en"
              ? sale.ouEnName
              : sale.ouLocaleName,
          transactionCreationDate: new Date(sale.transactionCreationDate).toLocaleString("en-EG", { timeZone:'UTC',hour12: false }),
          [`${this.currentLang === "en" ? "cityEnName" : "cityLocaleName"}`]:
            this.currentLang === "en" ? sale.cityEnName : sale.cityLocaleName,
          [`${this.currentLang === "en" ? "zoneEnName" : "zoneLocaleName"}`]:
            this.currentLang === "en" ? sale.zoneEnName : sale.zoneLocaleName,
          ...
          transactionItemReportDtoList: sale.transactionItemReportDtoList,
          isExpanded,
        };
      });
    } else {
